    ...
    <body>
      ...
      <nav class="navbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><span class="nav-submenuheader" id="subHeader" onclick="toggleSubMenu()"><span class="material-symbols-outlined">confirmation_number</span><span class = "link-text">Tickets</span>
